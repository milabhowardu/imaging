    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.featuredInner}>
        ...
        <p>
          <ul>
            ...
            <li>
              To offer student and faculty training opportunities in biomedical
              imaging sciences through methodology-centered seminars, workshops,
              mini-courses and internships
            </li>
            <li>
      ...
      <div className={classes.featuredInner}>
        ...
        <ul>
          ...
          <li>Disease Models (Alzheimer's disease, cardiovascular disease)</li>
        </ul>
