...
const SelectedPublications = () => {
  const selectedPublicationsList = [
    ...
    },
    {
      ...
      title: "Antitumor properties of Salvianolic acid B against triple-negative and hormone receptor-positive breast cancer cells via ceramide-mediated apoptosis.",
    ...
    {
      author: "Stinnett GR, Lin S, Korotcov AV, Korotcova L, Morton PD, Ramachandra SD, Pham A, Kumar S, Agematsu K, Zurakowski D, Wang PC, Jonas RA, Ishibashi N.",
    ...
    {
      author: "Gondré-Lewis MC, Gboluaje T, Reid SN, Lin S, Wang P, Green W, Diogo R, Fidélia-Lambert MN, Herman MM. ",
    ...
    {
      author: "Heier CR, Guerron AD, Korotcov A, Lin S, Gordish-Dressman H, Fricke S, Sze RW, Hoffman EP, Wang P, Nagaraju K. ",
    ...
    {
      author: "Zhang F, Shan L, Liu Y, Neville D, Woo JH, Chen Y, Korotcov AV, Lin S, Huang S, Sridhar R, Liang W, Wang PC. ",
      title: "An Anti-PSMA Bivalent Immunotoxin Exhibits Specificity and Efficacy for Prostate Cancer Imaging and Therapy.",
    ...
    {
      author: "Korotcov AV, Ye YP, Chen Y, Zhang FY, Huang S, Lin S, Sridhar R, Achilefu S, Wang PC.",
      title: "Glucosamine Linked Near-infrared Fluorescent Probes for Imaging of Solid Tumor Xenografts.",
    ...
    {
      author: "Meng H, Xing GM, Blanco E, Song Y, Zhao L, Sun BY, Li XD, Wang PC, Korotcov A, Li W, Liang XJ, Chen CY, Yuan H, Zhao F, Chen Z, Sun T, Chai ZF, Farrari M, Zhao YL.",
      title: "Gadolinium Metallofullerenol Nanoparticle Inhibits Cancer Metastasis through Matrix Metalloproteinase Inhibition: Imprisoning Instead of Poisoning Cancer Cells.",
    ...
    {
      author: "Liang XJ, Meng H, Wang Y, He H, Meng J, Lu J, Wang PC, Zhao Y, Gao X, Sun B, Chen C, Xing G, Shen D, Gottesman MM, Wu Y, Yin JJ, Jia L.",
      title: "Metallofullerene nanoparticles circumvent tumor resistance to cisplatin by reactivating endocytosis,",
    ...
    {
      author: " Wang PC, Blumenthal RP, Zhao YL, Schneider JA, Miller N, Grodzinski P, Gottesman MM, Tinkle S, Wang K, Wang C, Liang XJ.",
      title: "Building Scientific Progress Without Borders: Nanobiology and Nanomedicine in China and the U.S. Cancer Research,",
    ...
    {
      author: "Shan L, Zhang RS, Zhang WH, Lee E, Sridhar R, Snyderwine EG, Wang PC.",
      title: "Image-based Real-time Evaluation of the Molecular Events Underlying HC11 Mammary Epithelial Cell Differentiation. ",
